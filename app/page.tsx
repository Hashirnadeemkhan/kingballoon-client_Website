...
export const metadata: Metadata = {
  ...
  description:
    "King Balloon is Lahore's top inflatable rental company. Rent bounce castles, water slides, combo slides & giant games for birthdays, weddings & events. Call 0321-9555528 to book today!",
  alternates: {
    canonical: "https://www.kingballoon.pk",
  },
  openGraph: {
    title: "King Balloon | Bounce Castle Rental Lahore — Call 0321-9555528",
    description:
