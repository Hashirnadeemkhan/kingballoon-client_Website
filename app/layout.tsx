    ...
    <html lang="en">
      ...
      <body className={`${inter.className} bg-cream text-ink antialiased`}>
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold text-sm px-4 py-3 rounded-full shadow-2xl shadow-black/40 transition-all duration-300 hover:scale-105 hover:shadow-[#25D366]/40 group"
        >
